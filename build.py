...
def main():
    ...
    if "__CLASS_DATA__" not in html or "__STUDENT_DATA__" not in html or "__REGION_MAP__" not in html:
        print(
            "template.html thiếu placeholder __CLASS_DATA__ / __STUDENT_DATA__ / __REGION_MAP__.",
            file=sys.stderr,
        )
        sys.exit(1)
